...
const DICT: Record<Lang, Dict> = {
  en: {
    ...
    "omni.console.subtitle": "Cashflow, decision, project, principle — drop it raw, the model files it for you.",
    ...
    // ── Projects
    "projects.matrix.title": "McKinsey Strategy Matrix",
    "projects.matrix.subtitle": "Risk × Return positioning · bubble size = capital committed",
    "projects.matrix.axisY": "Expected return (×)",
    "projects.matrix.axisX": "Risk level",
    "projects.matrix.empty": "Add a project to populate the strategy matrix.",
    ...
    "oracle.confirm.delete": "Delete this report? This cannot be undone.",
    "oracle.toast.deleted": "Report deleted",
  ...
  zh: {
    ...
    // ── 智能命令栏（自然语言录入）
    "omni.placeholder": "在此倾倒你今日的任意商业进展、资金流水、决策或思考，AI 自动审计归档……",
    "omni.send": "回执",
    "omni.sending": "审计中…",
    ...
    "omni.console.model": "推理引擎",
    "omni.console.model.default": "系统默认引擎",
    "omni.console.model.empty": "请先在 Oracle 页面配置模型",

    // ── 项目
    "projects.matrix.title": "麦肯锡战略决策矩阵",
    "projects.matrix.subtitle": "风险 × 回报象限定位 · 气泡大小映射已投入资金",
    "projects.matrix.axisY": "预期回报 (×)",
    "projects.matrix.axisX": "风险等级",
    "projects.matrix.empty": "暂无项目，新建一笔押注后将自动出现在战略矩阵上。",
    "projects.matrix.quadrant.q1": "明星押注",
    "projects.matrix.quadrant.q2": "投机仓位",
    "projects.matrix.quadrant.q3": "防御阵地",
    "projects.matrix.quadrant.q4": "资金漏斗",
    ...
    "oracle.confirm.delete": "确定要删除这份报告吗？此操作不可撤销。",
    "oracle.toast.deleted": "报告已删除",
