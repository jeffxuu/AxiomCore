...
const DICT: Record<Lang, Dict> = {
  en: {
    ...
    "oracle.control.title": "Control Panel",
    "oracle.control.subtitle": "4SAPI credentials & engine",
    "oracle.control.apikey": "4SAPI API Key",
    "oracle.control.apikey.placeholder": "sk-…",
    "oracle.control.apikey.hint": "Stored encrypted server-side. Displayed masked.",
    "oracle.control.verify": "Verify & Fetch Models",
    "oracle.control.verifying": "Verifying…",
    "oracle.control.engine": "Model Engine",
    "oracle.control.engine.placeholder": "Select after verification",
    ...
    "oracle.execution.triggering": "Generating…",
  ...
  zh: {
    ...
    "oracle.control.title": "控制面板",
    "oracle.control.subtitle": "4SAPI 凭据与引擎",
    "oracle.control.apikey": "4SAPI API Key",
    "oracle.control.apikey.placeholder": "sk-…",
    "oracle.control.apikey.hint": "加密存储于服务端，仅以脱敏形式显示。",
    "oracle.control.verify": "Verify & Fetch Models",
    "oracle.control.verifying": "校验中…",
    "oracle.control.engine": "Model Engine",
    "oracle.control.engine.placeholder": "校验通过后可选",
    "oracle.control.save": "Save Config",
    "oracle.control.saving": "保存中…",
    "oracle.control.saved": "配置已保存",
    "oracle.control.verified": "拉取到 {count} 个模型",
    "oracle.execution.title": "执行面板",
    "oracle.execution.subtitle": "手动触发与计划",
    "oracle.execution.trigger": "Manual Trigger",
    "oracle.execution.triggering": "生成中…",
    "oracle.execution.schedule": "系统将于每日 23:30 (中国时间) 自动审计并生成日报。",
    "oracle.reports.title": "历史报告",
    "oracle.reports.subtitle": "最新在前",
    "oracle.reports.empty": "尚无报告。请手动触发或等待 23:30 自动生成。",
    "oracle.reports.kind.daily": "日报",
    "oracle.reports.kind.manual": "手动",
    "oracle.report.empty": "在左侧选择一份报告，查看正文。",
